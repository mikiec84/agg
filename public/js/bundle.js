...
},{"./ProjectModel":5,"backbone":10}],5:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./ProjectView":8,"backbone":10}],8:[function(require,module,exports){
/*global $*/
'use strict';
var Backbone = require('backbone'),
...
},{"../../lib/views/templates/_project.mu":9,"backbone":10}],9:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    return "      <div class=\"project-image\"><img class=\"img-responsive\" src=\"/images/portfolio/"
  ...
  stack1 = ((helper = (helper = helpers.images || (depth0 != null ? depth0.images : depth0)) != null ? helper : alias1),(options={"name":"images","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
